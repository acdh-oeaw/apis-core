...
class InstitutionInstitutionViewSet(viewsets.ModelViewSet):
    queryset = InstitutionInstitution.objects.all().filter_for_user()
...
class PersonInstitutionViewSet(viewsets.ModelViewSet):
    queryset = PersonInstitution.objects.all().filter_for_user()
...
class PersonPlaceViewSet(viewsets.ModelViewSet):
    queryset = PersonPlace.objects.all().filter_for_user()
...
class PersonPersonViewSet(viewsets.ModelViewSet):
    queryset = PersonPerson.objects.all().filter_for_user()
...
class PersonEventViewSet(viewsets.ModelViewSet):
    queryset = PersonEvent.objects.all().filter_for_user()
...
class PersonWorkViewSet(viewsets.ModelViewSet):
    queryset = PersonWork.objects.all().filter_for_user()
...
class InstitutionPlaceViewSet(viewsets.ModelViewSet):
    queryset = InstitutionPlace.objects.all().filter_for_user()
...
class InstitutionEventViewSet(viewsets.ModelViewSet):
    queryset = InstitutionEvent.objects.all().filter_for_user()
...
class InstitutionWorkViewSet(viewsets.ModelViewSet):
    queryset = InstitutionWork.objects.all().filter_for_user()
...
class EventWorkViewSet(viewsets.ModelViewSet):
    queryset = EventWork.objects.all().filter_for_user()
...
class EventEventViewSet(viewsets.ModelViewSet):
    queryset = EventEvent.objects.all().filter_for_user()
...
class PlaceEventViewSet(viewsets.ModelViewSet):
    queryset = PlaceEvent.objects.all().filter_for_user()
...
class PlaceWorkViewSet(viewsets.ModelViewSet):
    queryset = PlaceWork.objects.all().filter_for_user()
...
class PlacePlaceViewSet(viewsets.ModelViewSet):
    queryset = PlacePlace.objects.all().filter_for_user()
...
class WorkWorkViewSet(viewsets.ModelViewSet):
    queryset = WorkWork.objects.all().filter_for_user()
