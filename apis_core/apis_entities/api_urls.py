...
urlpatterns = [
    path(r"savenetworkfiles/", api_views.SaveNetworkFiles.as_view()),
    path(r"getorcreateentity/", api_views.GetOrCreateEntity.as_view(), name="GetOrCreateEntity"),
...
if "deep learning" in getattr(settings, "APIS_COMPONENTS", []) and "apis_highlighter" in settings.INSTALLED_APPS:
    ...
    urlpatterns.append(
        path(r"nlp_model/", TestDLModel.as_view(), name="TestDLModel"),
    )
...
if "apis_highlighter" in settings.INSTALLED_APPS:
    ...
    urlpatterns.extend(
        [
            path(r"annotatoragreement/", AnnotatorAgreementView.as_view(), name="AnnotatorAgreementView"),
            path(r"overlappinghighlights/", ShowOverlappingHighlights.as_view(), name="ShowOverlappingHighlights"),
        ]
    )
