...
urlpatterns = [
    ...
    url(r'^detail/passage/(?P<pk>[0-9]+)$',
        detail_views.PassageDetailView.as_view(), name='passage_detail'),
    url(r'^place/geojson/$', views.getGeoJson, name='getGeoJson'),
    url(r'^place/geojson/list/$', views.getGeoJsonList, name='getGeoJsonList'),
    url(r'^place/netpassage/list/$', views.getNetJsonList, name='getNetJsonList'),
