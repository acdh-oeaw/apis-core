...
class RDFPlaceParserNewTestCase(TestCase):
    ...
    def test_parse_person(self):
        o = RDFParserNew('http://d-nb.info/gnd/118650130', 'Person', uri_check=False)
        o.create_objct()
        ...
        o2 = o.save()
        print(o2)
        o3 = RDFParserNew('http://d-nb.info/gnd/118566512', 'Person', uri_check=False)
        o3.create_objct()
    ...
    def test_merge(self):
        o = RDFParserNew('http://d-nb.info/gnd/118566512', 'Person', uri_check=False)
        o.create_objct()
        o.save()
        o2 = RDFParserNew('http://d-nb.info/gnd/170686299', 'Person', uri_check=False).get_or_create()
        o.merge(o2)
    ...
    def test_institution(self):
        o = RDFParserNew('http://d-nb.info/gnd/1001454-8', 'Institution', uri_check=False)
        o.create_objct()
        o2 = o.save()
