...
@receiver(post_save, sender=Fragebogen, dispatch_uid="create_default_uri")
@receiver(post_save, sender=Frage, dispatch_uid="create_default_uri")
@receiver(post_save, sender=Belegzettel, dispatch_uid="create_default_uri")
@receiver(post_save, sender=Beleg, dispatch_uid="create_default_uri")
@receiver(post_save, sender=Multimedia, dispatch_uid="create_default_uri")
@receiver(post_save, sender=Anmerkung, dispatch_uid="create_default_uri")
@receiver(post_save, sender=Bedeutung, dispatch_uid="create_default_uri")
...
@receiver(m2m_changed, sender=Fragebogen.collection.through, dispatch_uid="create_object_permissions")
@receiver(m2m_changed, sender=Frage.collection.through, dispatch_uid="create_object_permissions")
@receiver(m2m_changed, sender=Belegzettel.collection.through, dispatch_uid="create_object_permissions")
@receiver(m2m_changed, sender=Beleg.collection.through, dispatch_uid="create_object_permissions")
@receiver(m2m_changed, sender=Multimedia.collection.through, dispatch_uid="create_object_permissions")
@receiver(m2m_changed, sender=Anmerkung.collection.through, dispatch_uid="create_object_permissions")
@receiver(m2m_changed, sender=Bedeutung.collection.through, dispatch_uid="create_object_permissions")
